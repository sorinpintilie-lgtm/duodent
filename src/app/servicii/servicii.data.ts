...
export const serviceContentOverrides: Partial<Record<string, ServiceContentOverride>> = {
  ...
  'implantologie:proteza-cu-capse-pe-implanturi': {
   ...
   'implantologie:faza-protetica-coroana': {
    excerpt:
      'Etapă din planul implanto-protetic, afișată separat pentru o orientare mai clară asupra tratamentului și a costurilor orientative.',
    articleIntro:
      'Faza protetică (coroană) face parte din serviciile Duo Dent din zona de implantologie. Pagina are rol informativ și te ajută să înțelegi mai clar unde se încadrează acest serviciu, în ce locație este disponibil și care este prețul orientativ afișat în listă. Recomandarea exactă și succesiunea etapelor se stabilesc după evaluarea clinică.',
    articleSections: [
      {
        title: 'Ce presupune',
        content: [
          'Această etapă face parte din tratamentul implanto-protetic și vizează componenta finală de restaurare, după inserarea implantului și după perioada necesară de integrare, atunci când cazul o permite.',
          'Soluția exactă se stabilește în funcție de planul de tratament, de poziția implantului și de tipul lucrării protetice recomandate.',
        ],
      },
      {
        title: 'Cum se integrează în tratament',
        content: [
          'Faza protetică nu este un tratament separat de implantologie, ci o etapă dintr-un plan mai amplu, stabilit individual pentru fiecare pacient.',
          'În unele cazuri, aceasta urmează după inserarea implantului, iar în altele poate presupune pași intermediari sau adaptări în funcție de evoluția clinică.',
        ],
      },
      {
        title: 'Informații utile',
        content: [
          ...
          'În prezent, valoarea afișată este de 200 EUR. În implantologie, unele poziții din listă reprezintă etape sau componente ale tratamentului, nu un tratament complet în sine.',
        ],
      },
    ],
    seoTitle: 'Faza protetică (coroană) | Duo Dent',
    seoDescription:
      'Detalii despre faza protetică (coroană) în cadrul serviciilor de implantologie Duo Dent, disponibilă în Valea Călugărească.',
  },

  'implantologie:4-implanturi-plus-lucrare-provizorie': {
    excerpt:
      'Pachet orientativ din zona implantologiei, prezentat separat pentru o înțelegere mai clară a structurii tratamentului.',
    articleIntro:
      '4 implanturi + lucrare provizorie face parte din serviciile Duo Dent din zona de implantologie. Pagina are rol informativ și te ajută să înțelegi mai clar ce include această opțiune, unde este disponibilă și care este prețul orientativ afișat în listă. Recomandarea exactă se stabilește după consultație și evaluarea clinică.',
    articleSections: [
      {
        title: 'Ce presupune',
        content: [
          'Această opțiune este prezentată ca pachet orientativ și combină inserarea a patru implanturi cu o lucrare provizorie, atunci când planul de tratament și situația clinică permit această abordare.',
          'Configurația exactă, etapele și materialele implicate se stabilesc individual, în funcție de nevoile funcționale și de particularitățile cazului.',
        ],
      },
      {
        title: 'Cum se stabilește indicația',
        content: [
          'Indicația pentru o astfel de soluție se stabilește doar după evaluarea clinică, analiza suportului osos și discuția despre obiectivele tratamentului.',
          'Nu toate cazurile urmează aceeași structură, iar uneori pot fi necesare investigații sau etape suplimentare înaintea tratamentului propriu-zis.',
        ],
      },
      {
        title: 'Informații utile',
        content: [
          'Serviciul este disponibil în Valea Călugărească. În pagina principală poți vedea rapid disponibilitatea și prețul orientativ afișat pentru acest serviciu.',
          'În prezent, valoarea afișată este de 12000 RON. Prețul are caracter orientativ și trebuie interpretat în contextul planului complet de tratament.',
        ],
      },
    ],
    seoTitle: '4 implanturi + lucrare provizorie | Duo Dent',
    seoDescription:
      'Detalii despre soluția 4 implanturi + lucrare provizorie în cadrul serviciilor de implantologie Duo Dent, disponibilă în Valea Călugărească.',
  },

  'implantologie:6-implanturi-plus-lucrare-provizorie': {
    excerpt:
      'Pachet orientativ din zona implantologiei, afișat separat pentru o orientare mai clară asupra etapelor și costurilor.',
    articleIntro:
      '6 implanturi + lucrare provizorie face parte din serviciile Duo Dent din zona de implantologie. Pagina are rol informativ și te ajută să înțelegi mai clar ce include această opțiune, unde este disponibilă și care este prețul orientativ afișat în listă. Recomandarea exactă se stabilește după consultație.',
    articleSections: [
      {
        title: 'Ce presupune',
        content: [
          'Această variantă este prezentată ca pachet orientativ și combină inserarea a șase implanturi cu o lucrare provizorie, acolo unde situația clinică permite acest lucru.',
          'Planul exact se stabilește în funcție de suportul existent, de necesitățile funcționale și de obiectivele tratamentului discutate cu medicul.',
        ],
      },
      {
        title: 'Cum se stabilește indicația',
        content: [
          'Indicația pentru această soluție se stabilește individual, după consultație și, atunci când este nevoie, după investigațiile recomandate.',
          'În implantologie, structura tratamentului poate varia de la un caz la altul, iar pachetul afișat în pagină are rol orientativ.',
        ],
      },
      {
        title: 'Informații utile',
        content: [
          'Serviciul este disponibil în Valea Călugărească. În pagina principală poți vedea rapid disponibilitatea și prețul orientativ afișat pentru acest serviciu.',
          'În prezent, valoarea afișată este de 15000 RON. Costul final se confirmă după stabilirea planului complet de tratament.',
        ],
      },
    ],
    seoTitle: '6 implanturi + lucrare provizorie | Duo Dent',
    seoDescription:
      'Detalii despre soluția 6 implanturi + lucrare provizorie în cadrul serviciilor de implantologie Duo Dent, disponibilă în Valea Călugărească.',
  },

  'implantologie:proteza-pe-4-implanturi-include-bonturile': {
    excerpt:
      'Soluție protetică pe implanturi, prezentată separat pentru a clarifica mai bine structura tratamentului.',
    articleIntro:
      'Proteză pe 4 implanturi (include bonturile) face parte din serviciile Duo Dent din zona de implantologie. Pagina are rol informativ și te ajută să înțelegi mai clar această opțiune, unde este disponibilă și care este prețul orientativ afișat în listă.',
    articleSections: [
      {
        title: 'Ce presupune',
        content: [
          'Această poziție din listă descrie o soluție protetică pe implanturi și este afișată separat pentru o orientare mai clară în structura tratamentului.',
          'Detaliile privind tipul lucrării, etapele clinice și laboratorul implicat se stabilesc în funcție de planul medical recomandat.',
        ],
      },
      {
        title: 'Cum se integrează în tratament',
        content: [
          'Această soluție face parte dintr-un plan implanto-protetic și nu se stabilește izolat, ci împreună cu etapele chirurgicale, protetice și de monitorizare.',
          'Medicul recomandă varianta potrivită în funcție de suportul clinic, de obiectivele funcționale și de particularitățile fiecărui caz.',
        ],
      },
      {
        title: 'Informații utile',
        content: [
          'Serviciul este disponibil în Valea Călugărească. În pagina principală poți vedea rapid disponibilitatea și prețul orientativ afișat pentru acest serviciu.',
          'În prezent, valoarea afișată este de 12500 RON. Prețul are caracter orientativ și poate varia în funcție de planul final de tratament.',
        ],
      },
    ],
    seoTitle: 'Proteză pe 4 implanturi (include bonturile) | Duo Dent',
    seoDescription:
      'Detalii despre proteză pe 4 implanturi cu bonturi incluse în cadrul serviciilor de implantologie Duo Dent, disponibilă în Valea Călugărească.',
  },

  'implantologie:proteza-pe-6-implanturi-include-bonturile': {
    excerpt:
      'Soluție protetică pe implanturi, afișată separat pentru o înțelegere mai clară a etapelor și costurilor orientative.',
    articleIntro:
      'Proteză pe 6 implanturi (include bonturile) face parte din serviciile Duo Dent din zona de implantologie. Pagina are rol informativ și te ajută să înțelegi mai clar această opțiune, unde este disponibilă și care este prețul orientativ afișat în listă.',
    articleSections: [
      {
        title: 'Ce presupune',
        content: [
          'Această opțiune descrie o lucrare protetică pe șase implanturi, prezentată distinct pentru a clarifica mai bine ce este inclus în listă.',
          'Structura finală a lucrării, materialele și pașii necesari sunt stabilite după evaluarea clinică și după planificarea completă a tratamentului.',
        ],
      },
      {
        title: 'Cum se integrează în tratament',
        content: [
          'Această soluție se integrează într-un plan implanto-protetic mai amplu, care poate include etape chirurgicale, protetice și controale periodice.',
          'Nu toate cazurile urmează aceeași succesiune de pași, iar recomandarea finală este întotdeauna personalizată.',
        ],
      },
      {
        title: 'Informații utile',
        content: [
          'Serviciul este disponibil în Valea Călugărească. În pagina principală poți vedea rapid disponibilitatea și prețul orientativ afișat pentru acest serviciu.',
          'În prezent, valoarea afișată este de 14000 RON. Costul final se confirmă în funcție de planul medical și de soluția protetică aleasă.',
        ],
      },
    ],
    seoTitle: 'Proteză pe 6 implanturi (include bonturile) | Duo Dent',
    seoDescription:
      'Detalii despre proteză pe 6 implanturi cu bonturi incluse în cadrul serviciilor de implantologie Duo Dent, disponibilă în Valea Călugărească.',
  },

  'implantologie:proteza-cu-capse-pe-implanturi': {
    excerpt:
      'Soluție protetică asociată implantologiei, prezentată separat pentru orientare mai clară în pagina de servicii.',
    articleIntro:
      'Proteză cu capse pe implanturi face parte din serviciile Duo Dent din zona de implantologie. Pagina are rol informativ și te ajută să înțelegi mai clar această opțiune, unde este disponibilă și care este prețul orientativ afișat în listă.',
    articleSections: [
      {
        title: 'Ce presupune',
        content: [
          'Proteza cu capse pe implanturi este inclusă în listă ca soluție protetică asociată implantologiei, pentru cazurile în care acest tip de stabilizare poate fi potrivit.',
          'Tipul exact de lucrare și modul în care se integrează în planul de tratament se stabilesc după consultație și evaluare clinică.',
        ],
      },
      {
        title: 'Cum se stabilește recomandarea',
        content: [
          'Recomandarea pentru această variantă se face în funcție de suportul clinic, de obiectivele funcționale și de soluția protetică cea mai potrivită pentru pacient.',
          'În unele cazuri, poate reprezenta o opțiune eficientă de tratament, însă alegerea finală aparține planului medical personalizat.',
        ],
      },
      {
        title: 'Informații utile',
        content: [
          'Serviciul este disponibil în Valea Călugărească. În pagina principală poți vedea rapid disponibilitatea și prețul orientativ afișat pentru acest serviciu.',
          'În prezent, valoarea afișată este de 6000 RON. Prețul are caracter orientativ și trebuie interpretat în contextul tratamentului complet.',
        ],
      },
    ],
    seoTitle: 'Proteză cu capse pe implanturi | Duo Dent',
    seoDescription:
      'Detalii despre proteză cu capse pe implanturi în cadrul serviciilor de implantologie Duo Dent, disponibilă în Valea Călugărească.',
  },
